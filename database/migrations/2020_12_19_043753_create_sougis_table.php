...
class CreateSougisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sougis', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('employeeName', 100)->nullable();
            $table->string('compId', 100)->nullable();
            ...
            $table->string('moshuMail' , 100)->nullable();
            ...
            $table->string('demTel' , 100)->nullable();
            $table->string('demAddress' , 100)->nullable();
            $table->string('payWay' , 100)->nullable();
            $table->string('cereId' , 100)->nullable();
            $table->string('creId' , 100)->nullable();
            $table->string('shuha' , 100)->nullable();
            $table->string('ohuse' , 100)->nullable();
            $table->string('returnItem' , 100)->nullable();
            $table->string('specialArea' , 1100)->nullable();
            $table->timestamps();
        });
    }
